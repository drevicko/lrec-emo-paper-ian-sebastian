...
A selection of commonly used emoji\footnote{as indicated by http://emojitracker.com/} with clear emotional content were hand selected as emotion indicators and tweets that contained at least one of the selected emoji were collected. We used Ekman's~\shortcite{Ekman1992Argument} emotion classification of six basic emotions for our experiments.
...
Over a three week collection period from February 2 to 22 2016, we collected a total of over half a million tweets, of which 190,591 were tagged by Twitter as English.
...
This is encouraging, as it indicates the existence of lexical features associated with emoji usage.
